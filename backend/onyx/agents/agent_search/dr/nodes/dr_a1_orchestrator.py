...
# from onyx.agents.agent_search.dr.constants import DR_TIME_BUDGET_DEFAULT
...
#         if iteration_nr == 1:
#             # Default time budget for non-agentic search
#             remaining_time_budget = 3.0
...
#     else:  # use_agentic_search is True
...
#             remaining_time_budget = DR_TIME_BUDGET_DEFAULT
