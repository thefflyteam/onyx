...
def parse_user_files(
    ...
    Args:
        ...
        user: User object to validate file ownership and LLM access (required for RBAC)
    ...
    if user is None:
        raise ValueError("User is required when processing user files or project files")
